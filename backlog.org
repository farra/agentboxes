...
:PROPERTIES:
:DESIGN: [[file:docs/design/002-composable-agent-environments.org::*Tasks][AB-002-06 in 002]]
:EFFORT: M
:HANDOFF:
:WORKED_BY:
:END:
...
:PROPERTIES:
:DESIGN: [[file:docs/design/002-composable-agent-environments.org::*Tasks][AB-002-09 in 002]]
:EFFORT: S
:HANDOFF:
:WORKED_BY:
:END:

Create docs/guides/agentbox-toml.md with full schema and examples.

*** TODO [AB-002-10] Create preset configurations                        :p3:
:PROPERTIES:
:DESIGN: [[file:docs/design/002-composable-agent-environments.org::*Tasks][AB-002-10 in 002]]
:EFFORT: S
:HANDOFF:
:WORKED_BY:
:END:
