...
*** TODO [AB-001-01] Create lib/substrate.nix with common tools          :p1:
:PROPERTIES:
:DESIGN: [[file:docs/design/001-layered-runtime-architecture.org::*Tasks][AB-001-01 in 001]]
:EFFORT: S
:HANDOFF:
:WORKED_BY:
:END:
...
*** TODO [AB-001-02] Update schmux to include substrate                  :p1:
:PROPERTIES:
:DESIGN: [[file:docs/design/001-layered-runtime-architecture.org::*Tasks][AB-001-02 in 001]]
:EFFORT: S
:HANDOFF:
:WORKED_BY:
:END:
...
*** TODO [AB-001-03] Create base OCI image with nix                      :p1:
:PROPERTIES:
:DESIGN: [[file:docs/design/001-layered-runtime-architecture.org::*Tasks][AB-001-03 in 001]]
:EFFORT: M
:HANDOFF:
:WORKED_BY:
:END:
...
:PROPERTIES:
:DESIGN: [[file:docs/design/001-layered-runtime-architecture.org::*Tasks][AB-001-04 in 001]]
:EFFORT: M
:HANDOFF:
:WORKED_BY:
:END:
...
*** TODO [AB-001-05] Port mkProjectShell from cautomaton-develops        :p2:
:PROPERTIES:
:DESIGN: [[file:docs/design/001-layered-runtime-architecture.org::*Tasks][AB-001-05 in 001]]
:EFFORT: M
:HANDOFF:
:WORKED_BY:
:END:

Enable deps.toml to devShell for project-specific configuration.

*** TODO [AB-001-06] Document user journey for local and remote          :p2:
:PROPERTIES:
:DESIGN: [[file:docs/design/001-layered-runtime-architecture.org::*Tasks][AB-001-06 in 001]]
:EFFORT: S
:HANDOFF:
:WORKED_BY:
:END:
...
:PROPERTIES:
:DESIGN: [[file:docs/design/001-layered-runtime-architecture.org::*Tasks][AB-001-07 in 001]]
:EFFORT: L
:HANDOFF:
:WORKED_BY:
:END:
